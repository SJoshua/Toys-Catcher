...
# ==============================================================================
# Based on https://github.com/tensorflow/models/tree/master/tutorials/image/cifar10
# ==============================================================================

"""Routine for decoding the training binary file format."""
...
def distorted_inputs(data_dir, batch_size):
  """Construct distorted input for model training using the Reader ops.
  ...
  read_input = read_model(filename_queue)
